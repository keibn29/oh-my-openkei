...
- After delivering the plan in chat mode (below the closing </planner-plan> tag), instruct the user to switch back to the @Orchestrator agent to execute the plan
